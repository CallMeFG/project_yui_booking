...
<h1 class="h2 mb-4"><?php echo $data['title']; ?></h1>

<div class="card">
    <div class="card-body">
        <form action="<?php echo URLROOT; ?>/admins/editMainBareng/<?php echo $data['id']; ?>" method="post">
            <div class="mb-3">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="skill_level" class="form-control" value="<?php echo $data['skill_level']; ?>">
                </div>
            </div>
                ...
                <select name="venue_id" class="form-select">
                    <?php foreach ($data['venues'] as $venue): ?>
                        <option value="<?php echo $venue->id; ?>" <?php echo ($data['venue_id'] == $venue->id) ? 'selected' : ''; ?>>
                            <?php echo $venue->name; ?> (<?php echo $venue->sport_type; ?>)
                        </option>
                    <?php endforeach; ?>
                </select>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" name="cost_per_person" class="form-control" value="<?php echo $data['cost_per_person']; ?>">
                </div>
            </div>
